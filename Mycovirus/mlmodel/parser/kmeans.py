...
path1 = os.path.join('training_data', 'Sclerotinia_nucleotide.fasta')
path01 = os.path.join('training_data', 'genbank_nucleotide.fasta')
...
def kmeansPCA(fastaList):
    ...
    for i in range(0, len(fastaList)):
        ...
        if len(inputData) > 1:
            ...
            path = os.path.join('media', 'images', 'kmeansPCA' + str(i) + '.png')
            images.append(path)
...
def kmeansTSNE(fastaList):
    ...
    for i in range(0, len(fastaList)):
        ...
        if len(inputData) > 1:
            ...
            path = os.path.join('media', 'images', 'kmeansTSNE' + str(i) + '.png')
            images.append(path)
            plt.savefig(path, bbox_inches='tight')
            plt.close()
...
def kmeansMeanshiftPCA(fastaList):
    ...
    for i in range(0, len(fastaList)):
        ...
        if len(inputData) > 1:
            ...
            plt.xlabel('First Principal Component')
            plt.ylabel('Second Principal Component')
            path = os.path.join('media', 'images', 'kmeansMeanshiftPCA' + str(i) + '.png')
            images.append(path)
            plt.savefig(path, bbox_inches='tight')
            plt.close()
...
def kmeansMeanshiftTSNE(fastaList):
    ...
    for i in range(0, len(fastaList)):
        ...
        if len(inputData) > 1:
            ...
            plt.xlabel('First Component')
            plt.ylabel('Second Component')
            path = os.path.join('media', 'images', 'kmeansMeanshiftTSNE' + str(i) + '.png')
            images.append(path)
            plt.savefig(path, bbox_inches='tight')
            plt.close()
        # inputData["Labels"] = newLabels        
...
def websiteScriptKmeans(fastaList):
    ...
    for i in range(0, len(fastaList)):
        ...
        if len(inputData) > 1:
            ...
            plt.xlabel('First Principal Component')
            plt.ylabel('Second Principal Component')
            path = os.path.join('media', 'images', 'visual' + str(i) + '.png')
            images.append(path)
