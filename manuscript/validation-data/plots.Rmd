...
tmpdat = read.table("../scripts/gmm/predictions_10__bestModel.csv", header=TRUE, sep=",")
str(tmpdat)
tmpdat2 = read.table("../scripts/gmm/pca_10_.csv", header=TRUE, sep=",")
str(tmpdat2)
dat$pred10 = tmpdat$Labels
dat$pred10.x1 = tmpdat2$principal.Component.1
dat$pred10.x2 = tmpdat2$Principal.Component.2

tmpdat = read.table("../scripts/gmm/predictions_10__only0s_bestModel.csv", header=TRUE, sep=",")
str(tmpdat)
tmpdat2 = read.table("../scripts/gmm/pca_10__only0.csv", header=TRUE, sep=",")
str(tmpdat2)
...
tmpdat = read.table("../scripts/gmm/predictions_50__bestModel.csv", header=TRUE, sep=",")
str(tmpdat)
tmpdat2 = read.table("../scripts/gmm/pca_50_.csv", header=TRUE, sep=",")
str(tmpdat2)
